...
const HeroSection = () => {
    ...
    // Year parsing
    const year = currentMovie.created ? currentMovie.created.substring(0, 4) : '2024';
            ...
            <div className="hero-content container-fluid">
                <div className="hero-left">
                    ...
                    <div className="hero-meta">
                        ...
                        <span className="meta-tag ep">{currentMovie.current_episode}</span>
                        <span className="meta-tag lang">{currentMovie.language}</span>
                    </div>
